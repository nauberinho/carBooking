        ...
        return(
            <div>
                ...
                <form onSubmit={this.handleSubmit} onChange={this.handleChange}>
                    ...
                    <br/>
                    <input value={this.state.updatedCar.requiredDrivingLicense} placeholder="Behörighet" id="requiredDrivingLicense" onChange={this.placeholderEvent} />
                    <br/>
                    <input value={this.state.updatedCar.brand} placeholder="Märke" id="brand" onChange={this.placeholderEvent} />
                    <br/>
                    <input value={this.state.updatedCar.model} placeholder="Modell" id="model" onChange={this.placeholderEvent} />
                    <br/>
                    <input value={this.state.updatedCar.year} placeholder="År" id="year" onChange={this.placeholderEvent} />
                    <br/>
                    <input value={this.state.updatedCar.fuel} placeholder="Bränsle" id="fuel" onChange={this.placeholderEvent} />
                    <br/>
                    <input value={this.state.updatedCar.gearbox} placeholder="Växellåda" id="gearbox" onChange={this.placeholderEvent} />
                    <br/>
                    <input value={this.state.updatedCar.dagshyra} placeholder="Dagshyra" id="dagshyra" onChange={this.placeholderEvent} />
                    <br/>
                    <input value={this.state.updatedCar.imgLink} placeholder="Bildlänk" id="imgLink" onChange={this.placeholderEvent} />
                    <br/>
                    <button>Spara</button>
                </form>
